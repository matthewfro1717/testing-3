...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("VsDave", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("VsDave", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "55";
		app.meta["company"] = "dnbteam";
		app.meta["file"] = "VsDave";
		app.meta["name"] = "Friday Night Funkin' | VS. Dave and Bambi 3.0b | Extra Keys Addon 2.0.2";
		app.meta["packageName"] = "dnbteam.daveandbambi";
		app.meta["version"] = "3.0.0";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: false,
			title: "Friday Night Funkin' | VS. Dave and Bambi 3.0b | Extra Keys Addon 2.0.2",
			width: 0,
			x: null,
			y: null,
		};
		...
		#elseif air
		app.window.title = "Friday Night Funkin' | VS. Dave and Bambi 3.0b | Extra Keys Addon 2.0.2";
		#else
